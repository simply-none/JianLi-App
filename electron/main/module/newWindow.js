...
import { appLogoIco, appName, indexHtml, preload, VITE_DEV_SERVER_URL, } from "../variables.ts";
...
export function createOtherWindow(arg, ops, recreate = false) {
    getScreenInfo();
...
export function initNewWindow() {
    ...
    // 打开新窗口
    ipcMain.on("open-new-window", (_, newWindowName, ops) => {
