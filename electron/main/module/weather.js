...
function saveWeatherDataToFile(cityName, html, data) {
...
async function crawlWeather(cityName) {
    let browser = null;
    let page = null;
    try {
        const commonParams = {
...
async function locatorStep(mystep, page) {
...
async function getWeather(cityName, forceRefresh = false) {
...
export function initWeather() {
    ...
    ipcMain.on("get-weather-broadcast", async (event, cityName) => {
        try {
