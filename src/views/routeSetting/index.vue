...
const groupDefs: MenuGroup[] = [
  ...
  { label: '效率工具', names: ['pomodoroRecord', 'clipboard', 'notebookApp', 'categorizableNotes', 'todoList', 'habit', 'accounting', 'stock', 'registerShortcut', 'function', 'weather', 'browser', 'ebookReader'] },
