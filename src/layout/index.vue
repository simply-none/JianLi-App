...
const groupDefs: MenuGroup[] = [
  ...
  { label: '效率工具', names: ['pomodoroRecord', 'clipboard', 'notebookApp', 'categorizableNotes', 'themeConversation', 'todoList', 'habit', 'countdown', 'accounting', 'stock', 'resume', 'registerShortcut', 'function', 'weather', 'browser', 'ebookReader', 'screenshot', 'downloader', 'colorPalette', 'qrCode'] },
